        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-8 pb-10">
            ...
            <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
                    <Link to={`/tenant/${currentTenant?.id}/projects`} className="hover:text-primary transition-colors">Projects</Link>
                    <span>/</span>
                    <span>New</span>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full md:w-1/3 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 px-4 py-2.5 text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                            >
