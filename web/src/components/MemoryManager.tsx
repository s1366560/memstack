    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">选择一个项目来查看和管理记忆</p>
        </div>
      </div>
    );
  }
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900">记忆管理</h3>
            <span className="text-sm text-gray-500">({memories.length} 条)</span>
          </div>
          <button
      ...
      <div className="p-6">
        {memories.length === 0 ? (
          <div className="text-center py-8">
            <Brain className="h-12 w-12 text-gray-400 mx-auto mb-3" />
            <h4 className="text-lg font-medium text-gray-900 mb-2">暂无记忆</h4>
          ...
          <div className="space-y-4">
            {memories.map((memory) => (
              ...
              >
                ...
                <div className="mb-3">
                  <h4 className="text-sm font-medium text-gray-900 mb-2">{memory.title}</h4>
