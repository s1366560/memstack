          ...
          <div className="p-6 space-y-4">
            ...
            {activeTab === 'memory' && (
              <>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="max_episodes" className="block text-sm font-medium text-gray-700 mb-1">
                      最大记忆片段数
                    </label>
                    <input
                      type="number"
                ...
                <div>
                  <label htmlFor="refresh_interval" className="block text-sm font-medium text-gray-700 mb-1">
                    自动刷新间隔（小时）
                  </label>
                  <input
                    type="number"
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <label htmlFor="auto_refresh" className="text-sm font-medium text-gray-700">
                    启用自动刷新
                  </label>
                </div>
              </>
            ...
            {activeTab === 'graph' && (
              <>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="max_nodes" className="block text-sm font-medium text-gray-700 mb-1">
                      最大节点数
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label htmlFor="max_edges" className="block text-sm font-medium text-gray-700 mb-1">
                      最大边数
                    </label>
                    <input
                      type="number"
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <label htmlFor="community_detection" className="text-sm font-medium text-gray-700">
                    启用社区检测
                  </label>
                </div>
              </>
