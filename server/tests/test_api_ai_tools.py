...
from server.api.ai_tools import OptimizeRequest, TitleRequest, generate_title, optimize_content
...
async def test_optimize_content():
    ...
    response = await optimize_content(request=request, graphiti=mock_graphiti, api_key=mock_api_key)
...
async def test_generate_title_api():
    ...
    response = await generate_title(request=request, graphiti=mock_graphiti, api_key=mock_api_key)
