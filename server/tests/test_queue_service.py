...
async def test_queue_service_add_episode():
    ...
    # Mock DB update to avoid DB connection
    ...
    queue_service._update_memory_status.assert_any_call(uuid, ProcessingStatus.PROCESSING)
    queue_service._update_memory_status.assert_any_call(uuid, ProcessingStatus.COMPLETED)
